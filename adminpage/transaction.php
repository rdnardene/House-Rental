        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="action.php" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="deletereserve" class="btn btn-secondary ">Yes</button>
                        <button type="submit" name="btnno" class="btn btn-primary">No</button>
                    </div>
                </form>
            </div>
                ...
                <?php
                  ...
                  <br />
                    ...
                    <table id="table" class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                            $query = $db->query("SELECT * FROM reserve");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success movebook">MoveToBook</button>
