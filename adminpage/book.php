            ...
            <div class="modal-content">
                ...
                <form action="action.php" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="confirmbook" class="btn btn-secondary ">Yes</button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="action.php" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="deletebook" class="btn btn-secondary ">Yes</button>
                        <button type="submit" name="btnno" class="btn btn-primary">No</button>
                    </div>
                </form>
            </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success movebook">Check In</button>
                                        <button type="button" class="btn btn-danger deletebook">Remove</button>
