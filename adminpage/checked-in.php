            ...
            <div class="modal-content">
                ...
                <form action="action.php" method="POST">
                    <div class="modal-body">
                        ...
                        <h4>Are you sure to checked out this category?</h4>
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="confirmcheckin" class="btn btn-secondary ">Yes</button>
    ...
    <div class="tabb">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-success movecheckout">Check Out</button>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.movecheckout').on('click', function() {
